...
function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('novelWritingAssistant.openConfig', openConfigFile), vscode.commands.registerCommand('novelWritingAssistant.openSettings', openSettings), vscode.commands.registerCommand('novelWritingAssistant.highlightSelection', handleHighlightSelection), vscode.commands.registerCommand('novelWritingAssistant.clearHighlights', clearHighlightRules), vscode.window.onDidChangeActiveTextEditor(() => updateAll()), vscode.workspace.onDidChangeTextDocument(event => {
        recordDocumentChange(event);
        updateAll();
    }), vscode.workspace.onDidOpenTextDocument(() => updateAll()), vscode.workspace.onDidCloseTextDocument(() => updateAll()), vscode.workspace.onDidChangeConfiguration(event => {
